...
TEMPLATES = {
    ...
    "hi-IN": {
        "approach": "अब {n} पहुँचने वाला है।",
        "passed": "आप {n} से आगे निकल चुके हैं।",
        "overshoot": "आप अपने स्टॉप से आगे निकल चुके हैं। कोई बात नहीं। कृपया यहीं, "
            "{n} पर उतरें।",
        "destination": "आप अपने गंतव्य {n} पर पहुँच गए हैं।",
        "wake_checkin": (
            "आपका स्टॉप {n} अगला है। जागने का संकेत देने के लिए अपने "
            "ईयरफ़ोन पर टैप करें, या स्क्रीन पर दिए बटन को दबाएँ।"
        ),
        "wake_up_stop": "जागिए! जागिए। आपका स्टॉप {n} अगला है।",
        "wake_up_change": "जागिए! जागिए। {n} पर ट्रेन बदलनी है, "
            "वह अगला स्टेशन है।",
    },
    "mr-IN": {
        "approach": "आता {n} येत आहे.",
        "passed": "आपण {n} मागे सोडले आहे.",
        "overshoot": "आपण आपल्या थांब्याच्या पुढे निघून गेला आहात. काही हरकत नाही. "
            "कृपया येथेच, {n} येथे उतरा.",
        "destination": "आपण आपल्या गंतव्यस्थानी {n} येथे पोहोचलात.",
        "wake_checkin": (
            "आपला थांबा {n} पुढचा आहे. आपण जागे आहात हे दाखवण्यासाठी "
            "आपल्या ईअरफोनवर टॅप करा, किंवा स्क्रीनवरील बटण दाबा."
        ),
        "wake_up_stop": "जागे व्हा! जागे व्हा. आपला थांबा {n} पुढचा आहे.",
        "wake_up_change": "जागे व्हा! जागे व्हा. {n} येथे ट्रेन बदलायची आहे, "
            "हे पुढचे स्टेशन आहे.",
    },
}
