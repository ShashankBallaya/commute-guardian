...
class PulseOutput {
  ...
  Future<void> chime() async {
    ...
    try {
      ...
      // the declared type is a lie, and it bites the moment anyone adds an
      // onTimeout closure to the timeout below. Leaving that armed in the one
      // audio path that fires every 45 s is not worth the words it saves.
